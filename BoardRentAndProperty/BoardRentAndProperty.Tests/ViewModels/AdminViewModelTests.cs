...
namespace BoardRentAndProperty.Tests.ViewModels
{
    ...
    public sealed class AdminViewModelTests
    {
        ...
        public async Task LoadAccountsAsync_ServiceReturnsData_PopulatesPagedItems()
        {
            ...
            this.adminService.AccountsResult = ServiceResult<List<AccountProfileDataTransferObject>>.Ok(accounts);
        ...
        {
            this.systemUnderTest.SelectedAccount = new AccountProfileDataTransferObject { Username = "target" };
        ...
        public async Task SuspendAccountAsync_SelectedAccount_CallsServiceAndReloadsAccounts()
        {
            ...
            this.systemUnderTest.SelectedAccount = new AccountProfileDataTransferObject { Id = Guid.NewGuid(), Username = "victim" };
        ...
        [Test]
        public async Task UnlockAndResetPassword_OnSuccess_SetCorrespondingSuccessMessages()
        {
            this.systemUnderTest.SelectedAccount = new AccountProfileDataTransferObject { Id = Guid.NewGuid() };
            ...
            await this.systemUnderTest.ResetPasswordWithValueAsync("NewSecurePass123!");
