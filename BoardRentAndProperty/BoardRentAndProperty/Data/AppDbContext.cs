        ...
        public void EnsureCreated()
        {
            ...
            command.CommandText = @"
                ...
                BEGIN
                    ...
                    INSERT INTO [Account] (Id, Username, DisplayName, Email, PasswordHash, IsSuspended, CreatedAt, UpdatedAt)
                    ...
                    INSERT INTO AccountRoles (AccountId, RoleId) VALUES (@adminId, @adminRoleId);
                END
            ";
